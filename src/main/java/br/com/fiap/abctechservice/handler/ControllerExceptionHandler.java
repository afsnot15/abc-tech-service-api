...
public class ControllerExceptionHandler {
    ...
    @ExceptionHandler(MinimiumAssistsRequiredException.class)
    public ResponseEntity<ErrorMessageResponse> errorMinAssistRequired(MinimiumAssistsRequiredException ex) {
    ...
    public ResponseEntity<ErrorMessageResponse> errorMaxAssistException(MaxAssistsException ex) {
        ErrorMessageResponse error = new ErrorMessageResponse(
                HttpStatus.BAD_REQUEST.value(),
                new Date(),
                ex.getMessage(),
